...
graph TD
  ...
  click jpeg README.md#lossy-visual-image
  click jpeg-mask README.md#lossy-visual-image
  click lerc_lossy README.md#lossy-numerical-raster
  click lerc_lossless README.md#lossless-raster
```
