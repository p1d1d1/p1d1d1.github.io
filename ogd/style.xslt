   ...
   <div class="container-fluid">
    <div class="entry">
      <details>
        ...
        <summary>
          <li>
            <a class="icon icon--after icon--external" href="{atom:link[@rel='alternate']/@href}"><xsl:value-of select="atom:title"/></a><br/>
            <p class="date"><xsl:value-of select="substring-before(atom:updated,'T')" disable-output-escaping="yes"/><br/><xsl:value-of select="atom:author" disable-output-escaping="yes"/></p>
          </li>
        </summary>
